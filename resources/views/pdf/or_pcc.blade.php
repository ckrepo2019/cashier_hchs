...
<body>
    ...
    <table style="width: 100%; font-size: 12px; table-layout: fixed;">
        <tr>
            <td style="padding-left: 50px;">{{$trans->sid}}</td>
            <td style="width: 50%; padding-left: 60px;">{{$trans->studname}}</td>
            <td style="width: 25%;text-align: right;">{{$gradelevel}} - {{$section}}</td>
        </tr>
        <tr>
            <td colspan="3" style="line-height: 6px;">&nbsp;</td>
        </tr>
        <tr>
            <td></td>
            <td colspan="2" style="padding-left: 30px;">{{ucwords(strtolower($amountstring))}}</td>
        </tr>
    </table>
    <br/>
    <table style="width: 100%;">
        <tr>
            <td colspan="3" style="height: 100px; vertical-align: top; padding: 0px;">
                <table style="width: 100%; margin: 0px; font-size: 11px; table-layout: fixed;">
                    @foreach($transdetail as $detail)
                        <tr>
                            <td style="width: 50%; padding-left: 20px;">{{ucwords(strtolower($detail->items))}}</td>
                            <td style="width: 30%; text-align: right;">{{number_format($detail->amount,2)}}</td>
                            <td></td>
                        </tr>
                    @endforeach
                </table>
        ...
        <tr>
            ...
            <td style="width: 30%; text-align: right;"> {{number_format($amount,2)}}</td>
            <td style="text-align: center; font-size: 12px;">{{auth()->user()->name}}</td>
        </tr>
    </table>
