    ...
    <table style="width: 100%; margin:20px 0px;">
        <tr>
            <td style="vertical-align: top; width: 100%; padding: 0px;">
                ...
                <table style="width:100%; margin-top: 80px; line-height: 10px;">
                    <tr>
                ...
                <div class="table" style="font-size: 18px !important; margin-top: 50px;padding-left: 30px; font-size: 10.5px; height: 100px;">
                ...
                {{-- <table style="width:100%; margin-top: 50px; line-height: 15px;">
                    @foreach($transdetail as $detail)
                        <tr>
                            <td style="font-size: 12px; width: 5%;">&nbsp;</td>
                            <td style="padding-right: 7px; font-size: 10.5px; text-align: left; width: 60%;">{{ucwords(strtolower($detail->items))}}</td>
                ...
                <div class="table" style="font-size: 14px; padding-top: 20px;">
                    <div class="table-row">
                        <div class="table-cell" style="text-align: right; width: 50%;">
                            {{$gradelevel}}&nbsp;
                        </div>
                        <div class="table-cell" style="text-align: center; width: 50%;">
                            {{date('m/d/Y',strtotime($trans->transdate))}}
                        </div>
                    </div>
                </div>
                <div class="table" style="font-size: 14px; padding-top: 20px;">
