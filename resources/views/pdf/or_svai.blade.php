	...
	{{-- <div style="width: 46%;float: left;">
		...
		<div class="table" style="font-size: 14px;">
			<div class="table-row">
				...
				<div class="table-cell" style="width: 90%; text-align: center;">
		...
		<div class="table" style="font-size: 14px;margin-top: 10px;;">
			<div class="table-row">
		...
		<br/>
		<div class="table" style="font-size: 13px;height: 210px;" style="border: 1px solid black;">
			@foreach($transdetail as $detail)
